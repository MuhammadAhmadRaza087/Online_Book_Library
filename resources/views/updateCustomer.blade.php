          ...
          <ul class="nav pcoded-inner-navbar ">
            ...
            <li class="nav-item pcoded-hasmenu">
              ...
              <ul class="pcoded-submenu">
                ...
                <li><a href="{{url('/deleteCustomer')}}">Delete Customer</a></li>
                <li><a href="{{url('/updateCustomer')}}">Update Customer</a></li>
              </ul>
            </li>
                      <li class="nav-item pcoded-hasmenu">
              ...
              <ul class="pcoded-submenu">
                ...
                <li><a href="{{url('/deleteBook')}}">Delete Books</a></li>
                <li><a href="{{url('/updateBook')}}">Update Books</a></li>
              </ul>
            </li>
          </ul>	
        </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            <div class="card">
              ...
              <div class="card-body">
                <h5>Fill the following details to update customer</h5>
                <hr />
                <form action="{{url('/editCustomer/'.$customer->id)}}" method="POST">
                  {{@csrf_field()}}
                  @method('PUT')
                  <div class="form-row">
