<!DOCTYPE html>
	...
	<head>
	    ...
	    {{-- <link rel="stylesheet" type="text/css" href="{{url('assets/css/noramalize.css')}}"> --}}
	    ...
	    <link rel="stylesheet" type="text/css" href="{{url('assets/css/allBook.css')}}">
         <!-- vendor css -->
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="right-element">
						{{-- <a href="#" class="user-account for-buy"><i class="icon icon-user"></i><span>{{$username}}</span></a> --}}
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$book->price}}</td>
                            <td>
                                <a href="{{url('/updateBook/'.$book->id)}}"><button type="button" class="btn btn-success">Buy</button>
                                </a>
                                </td>
                        </tr>
                        @endforeach
