                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('/updateCustomer/'.$customer->id)}}"><button type="button" class="btn btn-success">Edit</button>
                                            </a>
                                        <a href="{{url('/deleteCustomer/'.$customer->id)}}"><button type="button" class="btn btn-danger">Delete</button>
                                        </a>
                                        </td>
                                    </tr>
                                    @endforeach
